...
#
# Generated by export_simulation on Tue Sep 11 12:43:15 -0300 2018
#
################################################################################
...
'-reset_run' switch to the './arctan_0.sh' script.

./arctan_0.sh -reset_run
...
./arctan_0.sh -noclean_files

For more information on the script, please type './arctan_0.sh -help'.
