...
HD_PWD='C:/Users/zoticus/DSP_RDv6/DSP_RDv6.runs/xadc_dsp_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xadc_dsp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xadc_dsp.tcl
