...
HD_PWD='C:/Users/zoticus/DSP_RDv6/DSP_RDv6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log main0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source main0.tcl -notrace
