...
HD_PWD='C:/Users/zoticus/project_2/project_2.runs/arctan_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arctan_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arctan_0.tcl
