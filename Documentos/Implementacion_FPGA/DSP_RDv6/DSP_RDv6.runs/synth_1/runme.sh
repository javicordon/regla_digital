...
HD_PWD='C:/Users/zoticus/DSP_RDv6/DSP_RDv6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main0.tcl
